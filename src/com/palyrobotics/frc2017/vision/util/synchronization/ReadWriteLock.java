...
public class ReadWriteLock {
    ...
    public synchronized void unlockRead(){
        ...
        if(accessCount == 1){ threadReadCount.remove(callingThread); }
        else { threadReadCount.put(callingThread, (accessCount -1)); }
        notifyAll();
    }
    ...
    private boolean isOnlyReader(Thread callingThread){
        return threadReadCount.size() == 1 &&
                threadReadCount.get(callingThread) != null;
    }
