...
public class SerializationDeserializationTest {
	...
	public void checkSegmentsEqual(Trajectory.Segment a, Trajectory.Segment b) {
		assertTrue(almostEqual(a.acc, b.acc));
		assertTrue(almostEqual(a.jerk, b.jerk));
		assertTrue(almostEqual(a.vel, b.vel));
		System.out.println(a.pos + " " + b.pos);
		assertTrue(almostEqual(a.pos, b.pos));
		assertTrue(almostEqual(a.heading, b.heading));
		assertTrue(almostEqual(a.dt, b.dt));
		assertTrue(almostEqual(a.x, b.x));
		assertTrue(almostEqual(a.y, b.y));
	}
	...
	public void testTextFileSerialization() {
		...
		assertEquals("TestPath", deserialized.getName());
		assertEquals(deserialized.getLeftWheelTrajectory().getNumSegments(),
				path.getLeftWheelTrajectory().getNumSegments());
		assertEquals(deserialized.getRightWheelTrajectory().getNumSegments(),
